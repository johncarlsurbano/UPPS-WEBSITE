...
export const JobOrderLamination = ({requestData,route}) => {
  ...
  const personnelRequestDetails = request?.request_details.lamination_request_details
                    ...
                    <div className="billing-form-content w-full max-w-[100%]">
                      <table className="w-full max-w-[100%] border-black border-[1px]">
                        ...
                        <tr className="text-center">
                          ...
                          <td className="border-black border-[1px] py-2 text-center">
                            {`${request?.request_details.service_type.service_type_name} - ${personnelRequest?.last_name} - ${personnelRequest?.department.department_name}`}
                          </td>
