...
export const PaymentSlipLaminationForm = () => {
  ...
  const paymentSlip = paymentSlipData?.lamination_student_request

  const studentRequest = paymentSlip?.lamination_request
  
  const printRequestDetails = studentRequest?.lamination_request_details
