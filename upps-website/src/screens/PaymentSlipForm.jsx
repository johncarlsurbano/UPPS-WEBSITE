...
export const PaymentSlipForm = () => {
  ...
  const paymentSlip = paymentSlipData?.student_print_request

  const studentRequest = paymentSlip?.request
  
  const printRequestDetails = studentRequest?.print_request_details
