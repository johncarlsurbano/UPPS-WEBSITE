...
import { InventoryReportModal } from "./components/InventoryReportModal.jsx";
    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          <Route
            path="/finishgoodsportrait"
            element={<FinishedGoodsPortrait />}
          />
          <Route path="/inprocessinventory" element={<InProcessInventory />} />
          <Route path="/rawinventory" element={<RawInventory />} />
          <Route path="/inventory-modal" element={<InventoryReportModal />} />
          ...
          <Route
            path="/student/request/print"
            element={<StudentPrintingForm />}
          />
          <Route
            path="/student/request/bookbind"
            element={<StudentBookBindForm />}
          />
          <Route
            path="/student/request/laminate"
            element={<StudentLamination />}
          />
          ...
          <Route
            path="/bookbind/paymentslip"
            element={<BookBindPaymentSlip />}
          />
          <Route
            path="/lamination/paymentslip"
            element={<PaymentSlipLaminationForm />}
          />
          ...
          >
            ...
            <Route
              path="request/bookbind"
              element={<PersonnelBookBindingRequestForm />}
            />
            <Route
              path="request/laminate"
              element={<PersonnelLaminationRequestForm />}
            />
          ...
          <Route
            path="/officehead/joborderbookbindform"
            element={<JobOrderBookBind />}
          />
          <Route
            path="/officehead/joborderlaminationform"
            element={<JobOrderLamination />}
          />
        </Routes>
      </BrowserRouter>
