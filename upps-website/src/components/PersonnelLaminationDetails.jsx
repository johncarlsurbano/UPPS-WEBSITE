        ...
        <div className="grid grid-cols-2 gap-4 text-[#17153a]">
          ...
          {user.id === personnelRequest.id || user.role === "Office Head" ? ( 
              <div>
                  ...
                  <button onClick={() => window.open(requestData.lamination_personnel_request.pdf, "_blank")} href={requestData.lamination_personnel_request && requestData.lamination_personnel_request.pdf ? requestData.lamination_personnel_request.pdf : "#"} className="text-[#4d70f1] text-[1.1rem]   ">
                    {requestData.lamination_personnel_request && requestData.lamination_personnel_request.pdf ? "View File" : "N/A"}
                  </button>
              </div>
          ) : ( 
            <div>
