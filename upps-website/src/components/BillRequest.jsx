...
const BillRequest = ({
    ...
    const personnelRequestDetails = requestDetail.request_details.print_request_details
  ...
  return {
    ...
    "Request Type" : personnelRequestDetails ? personnelRequestDetails.printing_type.printing_type_name : "N/A",
    ...
    Action: (
        <Button
          ...
          onClick={() => generateBill(requestDetail, personnelRequestDetails.request_type.request_type_name)}
        ></Button>
    )
  }
}
