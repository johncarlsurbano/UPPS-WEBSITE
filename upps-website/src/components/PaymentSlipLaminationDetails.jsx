...
export const PaymentSlipLaminationDetails = ({ requestData, onClose }) => {
    const personnelRequest = requestData.lamination_request
    const personnelRequestDetails = requestData.lamination_request.lamination_request_details
      ...
      <div className="bg-[#ffffff] p-8 rounded-xl w-11/12 max-w-lg relative shadow-2xl border border-gray-700">
        ...
        <div className="grid grid-cols-2 gap-4 text-[#17153a]">
          <div>
            ...
            <p className='text-base'>{personnelRequest ? requestData.job_order_number : 'N/A'}</p>
          </div>
          <div>
