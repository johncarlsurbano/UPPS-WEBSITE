...
export const PaymentSlipBookBindDetails = ({ requestData, onClose }) => {
    const personnelRequest = requestData.book_bind_request
    const personnelRequestDetails = requestData.book_bind_request.book_binding_request_details
