...
export const StudentLaminationDetails = ({ requestData, onClose, onClick}) => {
  const personnelRequest = requestData.lamination_student_request.lamination_request;
  const printRequestDetails = personnelRequest ? personnelRequest.lamination_request_details : null;
